...
const MOTIVATION_VARIANTS: Record<string, { msg: string; sub: string }[]> = {
  ...
  earlyAndBehind: [
    ...
    { msg: "Bro. ₹{{saved}}?? Seriously?? 😭", sub: "At this rate your goal will be done in 40 years. Move." },
    { msg: "You started strong. Then stopped. 🙄", sub: "₹{{saved}} is not a vibe. Log something and fix this." },
    { msg: "₹{{saved}}. That's cute. 😐", sub: "Your goal is sitting there waiting. Go give it more money." },
    { msg: "Be honest. You forgot about this goal. 😬", sub: "₹{{saved}} saved. Time to remember why you set it." },
    { msg: "₹{{saved}}. I've seen better. 💀", sub: "Actually no I haven't. Go save something right now." },
    { msg: "Your goal is basically crying rn 😢", sub: "₹{{saved}} out of ₹{{target}}. Give it some love today." },
    { msg: "This is embarrassing. Fix it. 🔥", sub: "₹{{saved}} in. You can do better than this in your sleep." },
    { msg: "₹{{saved}}. Even a chai costs more. ☕", sub: "Start taking this seriously. Save something today." },
    { msg: "Bro are you even trying? 😤", sub: "₹{{saved}} saved. That's nothing. Less than nothing. Log it." },
    { msg: "The turtle is winning. You're not. 🐢", sub: "₹{{saved}} saved. Slow is fine. Zero effort is not." },
  ],
  behind: [
