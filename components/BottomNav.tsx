...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 max-w-md mx-auto">
      <div
        className="flex items-center h-[68px] px-8"
        style={{
      ...
      >
        <Link href="/" className="flex-1 flex flex-col items-center gap-1 active:scale-90 transition-transform">
          ...
          <span className="text-[10px] font-semibold" style={{ color: active("/") ? "#fff" : "#444" }}>Home</span>
        </Link>
        ...
        <Link href="/profile" className="flex-1 flex flex-col items-center gap-1 active:scale-90 transition-transform">
          ...
          <span className="text-[10px] font-semibold" style={{ color: active("/profile") ? "#fff" : "#444" }}>Profile</span>
        </Link>
      </div>
    </nav>
  );
